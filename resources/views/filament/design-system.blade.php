<style>
/*
 * Project Management System — Material Dashboard presentation system.
 * Presentation only: no routes, data, permissions, or application behavior.
 */
...
/* ================================================================
   LAYOUT CONTRACT
   The custom shell owns the desktop geometry. Filament must not add
   a second sidebar column or a second content offset.
   ================================================================ */
.fi-sidebar,
...
.fi-body,
.fi-main,
.fi-main-ctn { width: 100% !important; max-width: none !important; }

.fi-main {
    margin: 0 !important;
    padding: var(--md-topbar) 0 0 var(--md-sidebar) !important;
...
.fi-main-ctn {
    margin: 0 !important;
    padding: 0 var(--md-gutter) 40px !important;
    background: var(--md-bg) !important;
    min-width: 0 !important;
}
...
.pm-dashboard,
.pm-task-board {
    width: min(100%, var(--md-content-max)) !important;
    max-width: var(--md-content-max) !important;
...
.fi-header { padding-top: 22px !important; }
...
/* ================================================================
   ...
   ================================================================ */
.pm-dashboard { padding-bottom: 32px !important; }
...
.pm-kpi { position: relative; display: flex; flex-direction: column; min-height: 126px; padding: 20px !important; background: #fff !important; border-radius: var(--md-radius) !important; box-shadow: var(--md-shadow) !important; text-decoration: none !important; }
...
/* Full-width data workspace: this is the table zone in the supplied wireframe. */
...
/* Generic Filament surfaces/tables/forms retain the same grid. */
...
/* Existing dashboard utility components. */
...
/* Mobile: the desktop canvas collapses cleanly instead of retaining a phantom offset. */
